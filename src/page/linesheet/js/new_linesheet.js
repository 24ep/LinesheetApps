...
configOptions.forEach(option => {
    ...
    let optionList = '';
    new PythonShell(path.join(__dirname, '../config/new_linesheet_config.py'), { args: option.args })
    ...
    .on('message', message => {
        ...
        if (message) {
            i =   i +1;
            // optionLists[option.id] = message
                // ss = message
                arr_send[option.id] = [option.id,optionList]
...
// module.exports = arr_send
// module.exports = "hellow wordl";
// console.log('test')
